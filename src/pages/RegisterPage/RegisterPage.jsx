    ...
    return (
        <div>
            ...
            <div className={styleModule.body}>
                <div className={styleModule.title}>Đăng ký</div>
                <form>
                    ...
                    <div className={styleModule.inputgroup}>
                        ...
                        />
                        <i className={`${styleModule.eyeIcon} ${showComfirmPassword ? 'fa-solid fa-eye' : 'fa-solid fa-eye-slash'}`} onClick={() => setShowComfirmPassword(!showComfirmPassword)}></i>
                    </div>
                    <div className={styleModule.option}>
                        <div className={styleModule.fogotpassword}></div>
                        <div style={{ cursor: 'pointer' }} className={styleModule.toSignUp} onClick={() => { navigate('/login') }}>Bạn đã có tài khoản?</div>
                    </div>
                    <button onClick={e => handleSubmit(e)}>Đăng ký</button>
                </form>
            </div>

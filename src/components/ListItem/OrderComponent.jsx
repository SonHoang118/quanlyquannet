    ...
    return (
        <div style={{ width: '90%', display: 'flex', flexDirection: 'column', gap: 20 }}>
            <div className={styleModule.list_item}>
                ...
                {userInfor.auth === 'chef' && (
                    <button className={styleModule.submit_btn}>Chấp nhận</button>
                )}
            </div>
            <div className={styleModule.list_item}>
                <img src="https://assets.unileversolutions.com/v1/1187779.jpg" alt="" />
                <div className={styleModule.right}>
                    <div className={styleModule.name}>Cơm rang</div>
                    <div className={styleModule.infor}>
                        <div className={styleModule.count}>số lượng 1</div>
                        <div className={styleModule.id}><i className="fa-solid fa-desktop"></i>máy 05</div>
                        <div className={styleModule.time}><i className="fa-regular fa-clock"></i>5 phút trước</div>
                    </div>
                </div>
                {userInfor.auth === 'chef' && (
                    <button className={styleModule.cancel_btn}>Hủy</button>
